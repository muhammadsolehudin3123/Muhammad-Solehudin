 	...
 	<div class="wrapper">
 		<header class="main-header">
 			<a href="<?php echo base_url('admin-dashboard') ?>" class="logo">
 				...
 				<span class="logo-lg"><b>Admin</b>Solehudin Pemberi Gaji</span>
 			</a>
 					...
 					<ul class="nav navbar-nav">
 						<li class="dropdown user user-menu">
 							<a href="template/#" class="dropdown-toggle" data-toggle="dropdown">
 								<img src="<?php echo base_url(); ?>template/dist/img/soleh.jpg" class="user-image" alt="User Image">
 							...
 							<ul class="dropdown-menu animated fadeIn faster">
 								<li class="user-header">
 									<img src="<?php echo base_url(); ?>template/dist/img/soleh.jpg" class="img-circle" alt="User Image">
 									<p>
